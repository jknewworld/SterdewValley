...
public enum TreeName {
    ...
    MushroomTree("Mushroom Tree", ForAgingSeeds.mushroomTreeSeeds, new int[]{7, 7, 7, 7}, 28, 1, new Season[]{Season.AUTUMN, Season.SPRING, Season.SUMMER, Season.WINTER}, Ingredients.CommonMushroom),
