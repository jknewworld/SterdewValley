...
public enum Recipe {
    ...
    HashBrowns("hash browns", true, Map.of(Ingredients.POTATO, 1, Ingredients.OIL, 1), 90, 120, Ingredients.ASH_BROWNS, "game/Recipe/Hash_Browns.png"),
    ...
    CherryBomb("cherry bomb", false, Map.of(Ingredients.COPPER, 4, Ingredients.COAL, 1), 0, 50, Ingredients.CHERRY_BOMB,null),
    Bomb("bomb", false, Map.of(Ingredients.IRON, 4, Ingredients.COAL, 1), 0, 50, Ingredients.BOMB, null),
    MegaBomb("mega bomb", false, Map.of(Ingredients.GOLD, 4, Ingredients.COAL, 1), 0, 50, Ingredients.MEGA_BOMB, null),
    Sprinkler("sprinkler", false, Map.of(Ingredients.COPPER, 1, Ingredients.IRON, 1), 0, 0, Ingredients.SPRINKLER, null),
    QualitySprinkler("quality sprinkler", false, Map.of(Ingredients.IRON, 1, Ingredients.GOLD, 1), 0, 0, Ingredients.QUALITY_SPRINKLER,null ),
    IridiumSprinkler("iridium sprinkler", false, Map.of(Ingredients.GOLD, 1, Ingredients.IRIDIUM, 1), 0, 0, Ingredients.IRIDIUM_SPRINKLER, null),
    CharcoalKlin("charcoal klin", false, Map.of(Ingredients.WOOD, 20, Ingredients.COPPER, 2), 0, 0, Ingredients.CHARCOAL_KLIN, null),
    Furnace("furnace", false, Map.of(Ingredients.COPPER, 20, Ingredients.STONE, 25), 0, 0, Ingredients.FURNACE, null),
    Scarecrow("scarecrow", false, Map.of(Ingredients.WOOD, 50, Ingredients.COAL, 1, Ingredients.FIBER, 20), 0, 0, Ingredients.SCARECROW, null),
    DeluxeScarecrow("deluxe scarecrow", false, Map.of(Ingredients.WOOD, 50, Ingredients.COAL, 1, Ingredients.FIBER, 20, Ingredients.IRIDIUM, 1), 0, 0, Ingredients.DELUXE_SCARECROW,null ),
    BeeHouse("bee house", false, Map.of(Ingredients.WOOD, 40, Ingredients.COAL, 8, Ingredients.IRON, 1), 0, 0, Ingredients.BEE_HOUSE, null),
    CheesePress("cheese press", false, Map.of(Ingredients.WOOD, 45, Ingredients.STONE, 45, Ingredients.COPPER, 1), 0, 0, Ingredients.CHEESE_PRESS,null ),
    Keg("keg", false, Map.of(Ingredients.WOOD, 30, Ingredients.COPPER, 1, Ingredients.IRON, 1), 0, 0, Ingredients.KEG, null),
    Loom("loom", false, Map.of(Ingredients.WOOD, 60, Ingredients.FIBER, 30), 0, 0, Ingredients.LOOM, null),
    MayonnaiseMachine("mayonnaise machine", false, Map.of(Ingredients.WOOD, 15, Ingredients.STONE, 15, Ingredients.COPPER, 1), 0, 0, Ingredients.MAYONNAISE_MACHINE,null ),
    OilMaker("oil maker", false, Map.of(Ingredients.WOOD, 100, Ingredients.GOLD, 1, Ingredients.IRON, 1), 0, 0, Ingredients.OIL_MAKER, null),
    PreservesJar("preserves jar", false, Map.of(Ingredients.WOOD, 50, Ingredients.STONE, 40, Ingredients.COAL, 8), 0, 0, Ingredients.PRESERVES_JAR, null),
    Dehydrator("dehydrator", false, Map.of(Ingredients.WOOD, 30, Ingredients.STONE, 20, Ingredients.FIBER, 30), 0, 0, Ingredients.DEHYDRATOR, null),
    GrassStarter("grass starter", false, Map.of(Ingredients.WOOD, 1, Ingredients.FIBER, 1), 0, 0, Ingredients.GRASS_STARTER, null),
    FishSmoker("fish smoker", false, Map.of(Ingredients.WOOD, 50, Ingredients.IRON, 3, Ingredients.COAL, 10), 0, 0, Ingredients.FISH_SMOKER,null ),
